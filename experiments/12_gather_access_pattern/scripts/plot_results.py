...
SUMMARY_CSV = TABLES_DIR / "gather_access_pattern_summary.csv"
RELATIVE_CSV = TABLES_DIR / "gather_access_pattern_relative.csv"
STABILITY_CSV = TABLES_DIR / "gather_access_pattern_stability.csv"
...
def _plot_bars(frame: pd.DataFrame, x_column: str, y_column: str, output_path: Path, title: str, ylabel: str,
               *, yscale: str | None = None, baseline: float | None = None, color: str = "tab:blue") -> None:
...
def main() -> None:
    ...
    _plot_bars(
        ...
        "variant",
        "gpu_ms_median",
        CHARTS_DIR / "gather_access_pattern_median_gpu_ms.png",
        "Experiment 12: Median GPU Time by Distribution",
        "GPU ms (median)",
        yscale="log",
        color="tab:blue",
    )
    _plot_bars(
        ...
        "variant",
        "gbps_median",
        CHARTS_DIR / "gather_access_pattern_median_gbps.png",
        "Experiment 12: Median Bandwidth by Distribution",
        "GB/s (median)",
        yscale="log",
        color="tab:green",
    )
    _plot_bars(
        ...
        CHARTS_DIR / "gather_access_pattern_slowdown_vs_identity.png",
        "Experiment 12: Slowdown vs identity",
        "Slowdown factor",
        baseline=1.0,
        color="tab:red",
    )
    _plot_bars(
        ...
        CHARTS_DIR / "gather_access_pattern_stability_ratio.png",
        "Experiment 12: GPU Time Stability by Distribution",
        "p95 / median GPU ms",
        baseline=1.0,
        color="tab:orange",
    )

    print(f"[ok] Wrote Experiment 12 charts to {CHARTS_DIR.relative_to(ROOT)}.")

...
def _plot_aos_vs_soa_summary() -> bool:
    ...
    fig.suptitle("Experiment 06 AoS vs SoA", fontsize=14)
...
def main() -> None:
    if not _plot_aos_vs_soa_summary():
        raise FileNotFoundError(
            "No Experiment 06 rows found in benchmark_results.json. "
            "Run the benchmark first with --experiment 06_aos_vs_soa."
        )

# Experiment 40: Persistent Threads and Work Queues
...
## Local Contents
- `plan.md`: canonical experiment specification
- `results.md`: current measured conclusions and artifact links
- `results/`: generated tables and charts, ignored by default
- `runs/`: archived raw benchmark exports, ignored by default
